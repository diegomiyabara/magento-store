export const CART_ITEM_FIELDS: string = `
  uid
  id
  quantity
  is_active
...
export const CART_PRICE_FIELDS: string = `
...
export const SELECTED_SHIPPING_METHOD_FIELDS: string = `
  carrier_code
  method_code
  carrier_title
  method_title
...
export const AVAILABLE_SHIPPING_METHOD_FIELDS: string = `
  carrier_code
  method_code
  carrier_title
  method_title
...
export const APPLIED_COUPON_FIELDS: string = `
  code
`;

export const CART_ADDRESS_FIELDS: string = `
  firstname
  lastname
  company
  street
...
export const CART_EMAIL_FIELDS: string = `
  email
`;

export const CART_PAYMENT_FIELDS: string = `
...
export const CART_SHIPPING_ADDRESS_FIELDS: string = `
  ${CART_ADDRESS_FIELDS}
...
export const CART_BILLING_ADDRESS_FIELDS: string = `
  ${CART_ADDRESS_FIELDS}
`;

export const CART_PRICES_FIELDS: string = `
  prices {
    ${CART_PRICE_FIELDS}
  }
`;

export const CART_SUMMARY_FIELDS: string = `
  id
  total_quantity
`;

export const CART_DETAIL_FIELDS: string = `
  id
  total_quantity
  is_virtual
  ${CART_EMAIL_FIELDS}
...
export const GUEST_CART_QUERY: string = `
...
export const CUSTOMER_CART_QUERY: string = `
...
export const CREATE_GUEST_CART_MUTATION: string = `
...
export const ADD_PRODUCTS_TO_CART_MUTATION: string = `
...
export const UPDATE_CART_ITEM_MUTATION: string = `
...
export const REMOVE_CART_ITEM_MUTATION: string = `
...
export const APPLY_COUPON_TO_CART_MUTATION: string = `
...
export const REMOVE_COUPON_FROM_CART_MUTATION: string = `
...
export const MERGE_CARTS_MUTATION: string = `
...
export const ESTIMATE_SHIPPING_METHODS_MUTATION: string = `
...
export const SET_SHIPPING_METHOD_ON_CART_MUTATION: string = `
...
export const SET_GUEST_EMAIL_ON_CART_MUTATION: string = `
...
export const SET_SHIPPING_ADDRESS_ON_CART_MUTATION: string = `
...
export const SET_BILLING_ADDRESS_ON_CART_MUTATION: string = `
...
export const SET_PAYMENT_METHOD_ON_CART_MUTATION: string = `
...
export const PLACE_ORDER_MUTATION: string = `
