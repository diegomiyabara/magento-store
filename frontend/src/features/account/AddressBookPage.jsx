...
export default function AddressBookPage() {
  ...
  return (
    <>
      ...
      {account.isLoading ? <InlineLoadingState title="Carregando enderecos..." /> : null}
      {account.error ? (
        <InlineErrorState
      ...
      <section className="account-section">
        ...
        <div className="account-section-title">
          <h3>Address Book</h3>
          <span>{account.addresses.length} endereco(s)</span>
        </div>
        ...
        {account.addresses.length ? (
          ...
          <article className="account-block">
            <div className="account-block-body">
              <p>You have no addresses in your address book.</p>
            </div>
          </article>
        )}
      </section>
