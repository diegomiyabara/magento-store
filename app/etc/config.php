...
return [
     ...
     * CONFIG__DEFAULT__AI_INTEGRATION__AUTOMATIC_TRANSLATION__TRANSLATIONS_ENGINE__DEEPL_AUTH_KEY for ai_integration/automatic_translation/translations_engine/deepl_auth_key
     * CONFIG__DEFAULT__AI_INTEGRATION__AUTOMATIC_TRANSLATION__TRANSLATIONS_ENGINE__OPENAI_API_KEY for ai_integration/automatic_translation/translations_engine/openai_api_key
     * CONFIG__DEFAULT__AI_INTEGRATION__AUTOMATIC_TRANSLATION__TRANSLATIONS_ENGINE__OPENAI_PROJECT_ID for ai_integration/automatic_translation/translations_engine/openai_project_id
     * CONFIG__DEFAULT__AI_INTEGRATION__AUTOMATIC_TRANSLATION__TRANSLATIONS_ENGINE__GEMINI_API_KEY for ai_integration/automatic_translation/translations_engine/gemini_api_key
    ...
    'system' => [
        'default' => [
            ...
            'hyva_theme_general' => [
                'messages' => [
                    'success_message_timeout' => null,
                ],
                'demo_content' => [
                    'show_homepage_demo_content' => '1',
                ],
                'alpine_defer' => [
                    'defer_idle_timeout' => '4000',
                    'deferred_components' => '{"_1712233026687_687":{"selector":".product-slider section[x-data]:not([x-data] [x-data])","defer_until":"intersect"},"_1712233027612_612":{"selector":".product-info [x-data]:not([x-data] [x-data])","defer_until":"intersect"},"_1712233028224_224":{"selector":"#filters-content [x-data]:not([x-data] [x-data])","defer_until":"intersect"},"_1712233028850_850":{"selector":"#review_form","defer_until":"intersect"},"_1712233075252_252":{"selector":"section[x-data^=initRecentlyViewedProductsComponent]","defer_until":"intersect"},"_1712233076143_143":{"selector":"div[x-data^=initBundleOptions]","defer_until":"intersect"},"_1712233077441_441":{"selector":"#product_addtocart_form [x-data]:not([x-data] [x-data])","defer_until":"intersect"},"_1712233109466_466":{"selector":"#notice-cookie-block","defer_until":"idle"}}',
                ],
                'animations' => [
                    'enable_view_transition_gallery' => null,
                ],
                'speculation_rules' => [
                    'method' => 'prefetch',
                    'eagerness' => 'moderate',
            ...
            'correios_postingmethods_config' => [
                'settings' => [
                    'methods' => '{"_1537631079729_729":{"code":"40010","name":"Sedex"},"_1537631089209_209":{"code":"04162","name":"Sedex com contrato"},"_1537631097535_535":{"code":"41106","name":"PAC"},"_1537631104549_549":{"code":"04669","name":"PAC com contrato"},"_1537631113849_849":{"code":"40215","name":"Sedex 10"},"_1537631121853_853":{"code":"40290","name":"Sedex hoje"},"_1537631135489_489":{"code":"40045","name":"Sedex a cobrar"}}',
                ],
            ],
            'login_as_customer' => [
                'general' => [
            ...
            'catalog' => [
                'frontend' => [
                    'show_add_to_compare_on_product_page' => '1',
                    'show_add_to_compare_in_list' => '1',
                    'show_sidebar_in_list' => '1',
                    'list_mode' => 'grid-list',
            ...
            'hyva_theme_catalog' => [
                ...
                'developer' => [
                    'cache' => [
                        'product_list_item_block_cache_enabled' => '1',
                        'product_list_item_block_cache_lifetime' => '3600',
                    ],
                ],
            ],
            'general' => [
            ...
            'hyva_theme_fallback' => [
                'general' => [
                    ...
                    'list_part_of_url' => '{"_1612520818489_489":{"path":"/checkout\\/index"},"_1612520843057_57":{"path":"paypal\\/express\\/review"},"_1612776810949_949":{"path":"paypal\\/express\\/saveShippingMethod"},"_1645247921478_478":{"path":"paypal\\/transparent\\/redirect"},"_1645249412397_397":{"path":"paypal\\/transparent\\/response"},"_1712886078067_67":{"path":"customer\\/ajax\\/login"}}',
                ],
            ],
            'hyva_theme_pagebuilder' => [
                'images' => [
                    'background_lazy_load_default' => '0',
                ],
            ],
            'admin' => [
                'emails' => [
                ...
                'system_admin_design' => [
                    'active_theme' => 'MageOS/m137-admin-theme',
                ],
            ],
            'web' => [
                'url' => [
...
{{depend vat_id}}VAT: {{var vat_id}}{{/depend}}|',
            ...
            'carriers' => [
                ...
                'imaginationmedia_correios' => [
                    'active' => '1',
                    'name' => 'Correios',
                    'posting_methods' => '40010,41106',
                    'posting_freemethod' => '41106',
                    'login' => null,
                    'password' => null,
                    'weight_type' => 'kg',
                    'owner_hands' => null,
                    'received_warning' => null,
                    'declared_value' => null,
                    'validate_dimensions' => null,
                    'default_height' => null,
                    'default_width' => null,
                    'default_depth' => null,
                    'handling_fee' => null,
                ...
                'usps' => [
                    'active' => '0',
                    'usps_type' => 'USPS_XML',
                    'gateway_rest_prod_url' => 'https://apis.usps.com/',
                ...
                'correios' => [
                    'active' => '1',
                    'sallowspecific' => '0',
                    'model' => 'ImaginationMedia\\Correios\\Model\\Carrier\\Correios',
                    'name' => 'Correios',
                    'title' => 'Correios',
                    'specificerrmsg' => 'Cálculo não disponível, por favor verifique a conexão com o webservices e as dimensões e peso dos produtos.',
                    'function_mode' => '3',
                    'default_height' => '2',
                    'default_width' => '16',
                    'default_depth' => '11',
                    'webservice_url' => 'http://ws.correios.com.br/calculador/CalcPrecoPrazo.aspx?StrRetorno=xml',
                    'max_weight' => '30',
                    'showmethod' => '1',
                ],
            ],
            'rma' => [
                'general' => [
                    'enabled' => '0',
                    'increment_id_prefix' => 'RMA-',
                    'return_period' => '30',
                ],
                'policy' => [
                    'auto_approve' => '0',
                    'allowed_order_statuses' => 'complete',
                ],
                'email' => [
                    'sender_identity' => 'general',
                    'customer_new_template' => 'rma_email_customer_new_template',
                    'customer_status_change_template' => 'rma_email_customer_status_change_template',
                    'admin_new_template' => 'rma_email_admin_new_template',
            ...
            'system' => [
                'cron' => [
                    ...
                    'imaginationmedia_correios_updatetracks' => [
                        'schedule_generate_every' => '1',
                        'schedule_ahead_for' => '4',
                        'schedule_lifetime' => '2',
                        'history_cleanup_every' => '10',
                ...
                'bfcache' => [
                    'general' => [
                        'enable' => '1',
                        'enable_user_interaction_reload_minicart' => '1',
                        'auto_close_menu_mobile' => '1',
                    ],
                    'scope' => [
...
productalert',
                    ...
                    'exclude_selectors' => '.do-not-prerender',
                ],
                'view_transitions' => [
                    'enable' => '1',
                    'enable_admin' => '1',
                    'enable_for_bfcache' => '1',
                ],
                'full_page_cache' => [
                    ...
                    'varnish' => [
                        ...
                        'enable_404_cache' => '1',
                        'tracking_parameters' => [
                            'param__branch_match_id' => [
                                'param' => '_branch_match_id',
                            ],
                            'param__bta_c' => [
                                'param' => '_bta_c',
                            ],
                            ...
                            'param_matomo_campaign' => [
                                'param' => 'matomo_campaign',
                            ],
                            'param_matomo_cid' => [
                                'param' => 'matomo_cid',
                            ],
                            'param_matomo_content' => [
                                'param' => 'matomo_content',
                            ],
                            'param_matomo_group' => [
                                'param' => 'matomo_group',
                            ],
                            'param_matomo_keyword' => [
                                'param' => 'matomo_keyword',
                            ],
                            'param_matomo_medium' => [
                                'param' => 'matomo_medium',
                            ],
                            'param_matomo_placement' => [
                                'param' => 'matomo_placement',
                            ],
                            'param_matomo_source' => [
                                'param' => 'matomo_source',
                            ],
                            ...
                            'param_piwik_campaign' => [
                                'param' => 'piwik_campaign',
                            ],
                            'param_piwik_keyword' => [
                                'param' => 'piwik_keyword',
                            ],
                            ...
                            'param_redirect_log_mongo_id' => [
                                'param' => 'redirect_log_mongo_id',
                            ],
                            'param_redirect_mongo_id' => [
                                'param' => 'redirect_mongo_id',
                            ],
                            'param_rtid' => [
                                'param' => 'rtid',
                            ],
                            ...
                            'param_sb_referer_host' => [
                                'param' => 'sb_referer_host',
                            ],
                            'param_ScCid' => [
                                'param' => 'ScCid',
                            ],
                            ...
                            'param_utm_creative_format' => [
                                'param' => 'utm_creative_format',
                            ],
                            'param_utm_id' => [
                                'param' => 'utm_id',
                            ],
                            'param_utm_marketing_tactic' => [
                                'param' => 'utm_marketing_tactic',
                            ],
                            'param_utm_medium' => [
                                'param' => 'utm_medium',
                            ],
                ...
                'version_check' => [
                    ...
                    'releases_url' => 'https://mage-os.org/category/releases/',
                ],
                'backup' => [
            ...
            'ai_integration' => [
                'automatic_translation' => [
                    ...
                    'catalog' => [
                        'text_attribute_to_translate' => null,
                        'select_attribute_to_translate' => null,
                        'enable_periodic_retranslation' => null,
                        'retranslation_period' => null,
                        'translate_disabled' => null,
                        'enable_url_rewrite' => null,
                        'product_translation_cron' => null,
                        'select_attribute_translation_cron' => null,
                    ],
                    'translations_engine' => [
                        'engine' => null,
                        'openai_org_id' => null,
            ...
            'cms' => [
                'pagebuilder_template_importexport' => [
                    'enable' => '1',
                    'sync_templates_by_cron' => '0',
                    'dropbox_credentials' => null,
                ],
                'wysiwyg' => [
                    'enabled' => 'enabled',
...
Disallow: /*SID=
    ...
    'themes' => [
        ...
        'adminhtml/MageOS/m137-admin-theme' => [
            'parent_id' => 'Magento/backend',
            'theme_path' => 'MageOS/m137-admin-theme',
            'theme_title' => 'M137 Admin Theme',
            'is_featured' => '0',
            'area' => 'adminhtml',
            'type' => '0',
            'code' => 'MageOS/m137-admin-theme',
        ],
